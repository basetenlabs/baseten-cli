// Package docs emits a versioned JSON description of the baseten-cli command
// tree for consumption by docs.baseten.co. The schema is the contract; bump
// SchemaVersion on any breaking change and coordinate with the consumer.
package docs
